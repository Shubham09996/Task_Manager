        ...
        >
           <div className="rounded-2xl border border-white/10 bg-[#16171d]/80 backdrop-blur-xl p-4 shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-[11px] font-mono text-gray-500 bg-black/30 px-3 py-1 rounded">flow.ai/signup</div>
              </div>
              <div className="aspect-[4/3] sm:aspect-[16/10] bg-[#000000]/40 rounded-xl flex items-center justify-center relative overflow-hidden border border-white/5">
                 <DotLottieReact
                    src="https://lottie.host/d7dc791b-dda8-46b7-b47f-85a7592604de/dMcmgnn4aW.lottie"
                    loop
                    autoplay
         ...
         <div className="w-full max-w-md relative z-10">
           ...
           >
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/10 mb-6">
                ...
                <span className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Create an account</span>
             </div>

             <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Join Flow today</h2>
             <p className="text-gray-400 text-sm mb-8 font-light">Enter your details below to get started.</p>
             ...
             <p className="text-center text-sm text-gray-400 mt-8 font-light">
               Already have an account? <Link to="/login" className="text-white hover:text-[#c084fc] font-medium transition-colors">Sign in</Link>
             </p>
           </motion.div>
         </div>
      </div>
